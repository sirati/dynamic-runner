"""Execution worker manager implementation.

This module provides the execution responsibilities:
- Worker lifecycle management (create, start, restart, terminate)
- Time-critical OOM detection and killing
- Local worker creation and socket management
...
class ExecutionWorkerManBaseImpl(WorkerManagerBase):
    """Worker manager with execution responsibilities.

    Provides:
    - Local worker creation (subprocess-based)
