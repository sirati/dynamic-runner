...
Mirrors :mod:`tests.e2e.test_consumer.__main__` verbatim with the
consumer module name swapped — the secondary ``image_name`` is shared
because the slurm-test-env container layout is the same regardless of
which Python topology dispatches.
"""
